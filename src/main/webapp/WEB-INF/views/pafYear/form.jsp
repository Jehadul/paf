...
<input id="id" name="id" value="${pafYear.id}" type="hidden"
	class="form-control" />
<div class="form-group">
	...
	<div class="col-sm-6">
		<input id="name" disabled="disabled" readonly="readonly" value="${pafYear.name}"
			class="form-control" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-6">
		<input id="fromDate" name="fromDate" value="${pafYear.fromDate}" type="eu-date1" class="form-control" title="format: DD-MM-YYYY"/>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-6">
		<input id="toDate" name="toDate" value="${pafYear.toDate}" type="eu-date2"
			class="form-control" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-6">
		<textarea class="form-control" id="remarks" name="remarks">${pafYear.remarks}</textarea>
	</div>
</div>
